...
public class Reajustar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insira a taxa de reajuste:");

        jLabel2.setText("Insira o numero da conta:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if(Integer.parseInt(numero.getText()) != CriarContaPoupanca.contaPoup.getNumero())
        {
            JOptionPane.showMessageDialog(null, "A Conta " + numero.getText() + " não é do tipo poupança");
            new Operacoes().setVisible(true);
            this.dispose();
        }
        else
        {
            ...
            {
                CriarContaPoupanca.contaPoup.reajusta();                
            }
            else
            {
                CriarContaPoupanca.contaPoup.setTaxa(Double.parseDouble(taxa.getText()));
                CriarContaPoupanca.contaPoup.reajustar();              
            }
            new Operacoes().setVisible(true);
            this.dispose();
        }
